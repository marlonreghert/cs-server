...
class RdsVenueStore:
    ...
    _CRAWL_TARGET_COLUMNS = (
        ...
        "initial_lookback", "results_limit", "cursor_posts_at", "cursor_reels_at",
    ...
    _CRAWL_TARGET_SELECT = (
        ...
        "initial_lookback, results_limit, cursor_posts_at, cursor_reels_at, "
        "last_run_at, last_run_results, last_run_cost_usd, consecutive_failures, "
        "notes, created_at, updated_at FROM events.crawl_target"
    )
