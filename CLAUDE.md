...
This is the **canonical** agent guide for this repository — for Claude, Codex,
and other coding agents. `AGENTS.md` is a thin pointer to this file.
...
Canonical lifecycle skill workflows live under
`.claude/skills/<skill-name>/SKILL.md`. `.agents/skills/<skill-name>/` holds thin
Codex refs (plus `openai.yaml`) that point back to those canonical workflows.
