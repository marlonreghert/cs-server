...
Claude mapping: `/plan-feature` maps to
`.claude/skills/plan-feature/SKILL.md`, which delegates to this skill.
...
Read `AGENTS.md` first. It is the source of truth for this repository's agent
rules.
